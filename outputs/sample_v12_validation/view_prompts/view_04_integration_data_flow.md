...
- **View:** Integration & Data Flow View
- **View ID:** view_04_integration_data_flow
- **Layout strategy:** orthogonal flow view emphasizing APIs, events, sync/async integrations, payload types, and system boundaries
- **Primary layout template:** `service_orchestration_workflow`
- **Template name:** Service orchestration and portal workflow map
...
- Style profile: neutral_process_blue
- Primary: #3B66D9
- Secondary: #9ED3E8
- Accent: #5B6470
- Container: #F5F6F8
- Border: #5D88CC
- Guidance: Use for workflow, portal, and orchestration swimlane diagrams.

## Internal reference assets to learn from
- Service portal and orchestration workflow map | family=service_orchestration_workflow | intent=Show workflows across portal, orchestration, billing, provisioning, network management, and operations. | placement=multiple horizontal swimlanes with sequential boxes and a future-state callout panel on the right | palette=#F0F0F0, #E0E0E0, #E0E0F0, #E0F0F0, #C0C0C0
