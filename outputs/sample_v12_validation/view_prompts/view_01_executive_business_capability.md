...
- **View:** Executive / Business Capability View
- **View ID:** view_01_executive_business_capability
- **Layout strategy:** value chain or capability map with key enablers, business outcomes, and a CIO-ready outcome statement
- **Primary layout template:** `platform_value_chain`
