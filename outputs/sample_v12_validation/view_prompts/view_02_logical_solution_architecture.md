...
- **View ID:** view_02_logical_solution_architecture
- **Layout strategy:** primary chosen reference layout with central platform boundary, capability groups, actors, systems, and cross-cutting bands
