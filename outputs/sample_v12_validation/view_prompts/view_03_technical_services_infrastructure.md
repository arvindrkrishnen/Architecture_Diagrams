...
- **View:** Technical Services & Infrastructure Detail
- **View ID:** view_03_technical_services_infrastructure
- **Layout strategy:** runtime and deployment view grouped by compute, storage, networking, security, CI/CD, resilience, and observability
- **Primary layout template:** `cloud_tenant_microservices`
- **Template name:** Cloud microservices with tenant and peripheral integration
...
- Cloud tenant microservices architecture | family=cloud_tenant_microservices | intent=Show a migration path from edge devices through client or tenant systems into APIs, microservices, storage, and admin functions in the cloud. | placement=left peripherals and devices, center tenant/mobile stack, right cloud platform with nested zones | palette=#F0F0F0, #E0E0E0, #A0A0A0, #C0C0C0, #808080
